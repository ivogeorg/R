...
1. Follow the approach in ISLR 3.2.2, following the 4 questions:
...
3. Plots:
    ...
    + multi-dimensional plot highlighting the residuals, potentially testing the linearity assumption
4. Investigate relaxations of the linear model assumptions, additivity and linearity, and interpret in the conclusion.
5. Rewrite the abstract to reflect the new analysis. State everything clearly.
6. Style:
    + remove verbosity
    + leave enough r code chunks to keep the document together
    ...
    + collect plots into multi-plot figures
